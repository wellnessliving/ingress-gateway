...
variable "configmap_metadata" {
  ...
  default = [
    {
      name      = "wl-ds-test-global-functions"
      namespace = "ingress-nginx"
    },
    {
      name      = "wl-ds-test-server-logic-conf"
      namespace = "ingress-nginx"
    },
    {
      name      = "wl-ds-test-global-maps-conf"
      namespace = "ingress-nginx"
    },
    {
      name      = "wl-ds-test-rewrite-dispatcher"
      namespace = "ingress-nginx"
    },
    {
      name      = "wl-ds-test-server-vars-conf"
      namespace = "ingress-nginx"
    }
  ]
}
...
locals {
  config_files   = ["global-functions.lua", "server_logic.conf", "global_maps.conf", "rewrite_dispatcher.lua", "server_vars_test.conf"]
